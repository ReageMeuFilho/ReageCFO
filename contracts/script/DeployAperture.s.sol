...
contract DeployAperture is Script {
    ...
    function run() external {
        ...
        // 2. _agentWallet: AI agent's wallet (for now, use deployer, will update later)
        // 3. _owner: Contract owner (deployer)
        ...
        console.log("3. Deposit initial funds for testing");
        console.log("4. Configure LayerZero peer on destination chain (Base Sepolia)");
        console.log("5. Deposit funds into ApertureVault on Base Sepolia");
        console.log("");
        ...
        console.log("");
        console.log("Set LayerZero peer (Base Sepolia):");
        console.log("  cast send", address(aperture), "\"setPeer(uint32,bytes32)\" 40245 <VAULT_ADDRESS_AS_BYTES32> --rpc-url sepolia --private-key $PRIVATE_KEY");
        console.log("");
